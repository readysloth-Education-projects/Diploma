\chapter{Процесс сертификации ПО на отсутствие НДВ}\label{ch:ch1}
...
которые могут являться как злым умыслом\autocite{compile-a-virus}\autocite{ken-thompson-hack} 
разработчиков\footnote{Разработчиков компилятора, линкера и других вспомогательных программ},
...
\section{Классификация НДВ}\label{sec:ch1/sec1}
\subsection{По применению}
\begin{itemize}
...
\section{Степень опасности НДВ}\label{sec:ch1/sec2}
    ...
    \begin{center}
        \begin{tabular}{ | c | c | c | c | }
            ...
            \cline{2-4}
                   & 1 Тип & 2 Тип & 3 Тип\\
            \hline
            \makecell{Наличие НДВ в системном ПО,\\ используемом в ИСПДн} & актуально & неактуально & неактуально \\
            \hline
            \makecell{Наличие НДВ в прикладном ПО \\ используемом в ИСПДн} & \makecell{актуально \\ или \\ неактуально} & актуально & неактуально \\
            \hline
        \end{tabular}
    \end{center}
